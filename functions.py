...
#%%
def parcellized_brain_vecs(brain_img, atlas_name):
    '''
    Parameters:
...
#%%
def get_neighbors(data, test_v, k, metric):
    ...
    Parameters:
        ...
        test_v : list of floats
            Vector representing specific brain image
...
def predict_class(data, test_v, k, metric):
    ...
    Returns:
        String (or int) with class prediction
    '''
